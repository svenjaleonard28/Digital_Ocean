...
load_dotenv('/Users/svenjaleonard/Desktop/GitHub/ece-140a-winter-2023-svenjaleonard28/Tech Assignment 3/Extra_Credit_1/credentials.env')

db_user = os.getenv('MYSQL_USER')
db_pass = os.getenv('MYSQL_PASSWORD')
db_name = os.getenv('MYSQL_DATABASE')
db_host = os.getenv('MYSQL_HOST') # must 'localhost' when running this script outside of Docker
